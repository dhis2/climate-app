...
const SetupPage = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <p>
                {i18n.t(
                    'Before you can import data, you need to make some configurations in the Maintenance app. For detailed instructions on how to configure DHIS2, choose which dataset you would like to import below.'
                )}
            </p>
            <Dataset
                selected={dataset}
