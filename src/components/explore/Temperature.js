...
const meanTemperature = datasets.find(
  (d) => d.id === "ECMWF/ERA5_LAND/DAILY_AGGR/temperature_2m"
);

const minTemperature = datasets.find(
  (d) => d.id === "ECMWF/ERA5_LAND/DAILY_AGGR/temperature_2m_min"
);

const maxTemperature = datasets.find(
  (d) => d.id === "ECMWF/ERA5_LAND/DAILY_AGGR/temperature_2m_max"
);
